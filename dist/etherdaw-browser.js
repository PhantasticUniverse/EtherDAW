...
var CHORD_VOICINGS = {
  ...
  "maj7": {
    "close": [0, 4, 7, 11],
    // Standard close voicing
    "drop2": [0, 7, 11, 16],
    // Second voice dropped an octave (airy, open)
    "drop3": [0, 11, 16, 19],
    // Third voice dropped an octave
    "shell": [0, 11, 16],
    // Root, 7th, 3rd (no 5th - cleaner)
    "open": [-12, 0, 7, 16]
    // Wide spacing across octaves
  },
  // Minor 7th voicings
  "m7": {
    "close": [0, 3, 7, 10],
  ...
  "m9": {
    "close": [0, 3, 7, 10, 14],
    "drop2": [0, 7, 10, 14, 15],
    // Drop2 for m9 - spread out
    "shell": [0, 10, 14, 15],
    // Root, 7th, 9th, 3rd
    "open": [-12, 0, 10, 14, 15]
    // Wide with bass note down
  },
  // Major 9th voicings
  "maj9": {
    "close": [0, 4, 7, 11, 14],
  ...
  "m": {
    "close": [0, 3, 7],
    "open": [-12, 0, 7, 15]
    // Wide minor with octave doubling
  },
