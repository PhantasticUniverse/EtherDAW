...
var CHORD_REGEX = /^([A-G][#b]?)((?:minmaj|mM|m\/M|maj|min|m|M|dim|aug|o|ø|\+|lyd|dom|quartal|quintal|so_what|mu|power|shell)?(?:7sus[24]?|9sus[24]?|11sus[24]?|13sus[24]?|sus[24]?)?(?:\d+)?(?:add\d+)?(?:alt)?(?:[b#]\d+)*)(?:@(\w+))?(?:\/([A-G][#b]?))?:(\d+|[whq])(\.?)([*~>^]?)$/;
var CHORD_INTERVALS = {
  // ============================================
  // TRIADS (3 notes)
  // ============================================
